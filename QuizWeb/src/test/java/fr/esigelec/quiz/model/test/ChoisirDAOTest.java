...
public class ChoisirDAOTest {
	...
	public void testgetNbBonnesReponses(){
		...
		listeQuestion1.add(new Question(100,"libelle1Q1"));
		listeQuestion1.add(new Question(101,"libelle1Q2"));
		...
		Personne p2= new Personne (1001,"Richard","richard","rouxrichard@der.fr","mdp2",0);
		...
		p2=personneDAO.getPersonne(1001);
		
		

		
		Quiz quiz1 = new Quiz(100,"libelleQuiz1-1",1,Timestamp.valueOf("2017-01-16 10:10:10.0"),1,1,Timestamp.valueOf("2017-01-16 10:16:10.0"),listeQuestion1);
		...
		Proposition prop1 = new Proposition(100,"libelleprop1", 1, listeQuestion1.get(0));
		Proposition prop2 = new Proposition(101,"libelleprop2", 1, listeQuestion1.get(0));
		...
		int nbbonnesRp=cdao.getNbBonnesReponses(100,100);
